var AccessModal = (function () {
	...
	function assignInDefaults(objValue, srcValue, key, object) {
	  if (objValue === undefined ||
	      (eq(objValue, objectProto$1[key]) && !hasOwnProperty.call(object, key))) {
	    return srcValue;
	  }
	  return objValue;
	}
	...
	function isError(value) {
	  ...
	  return (objectToString$1.call(value) == errorTag) ||
	...
	class AccessModal {
	    ...
	    constructor(options) {
	        ...
	        this.options = lodash_merge(defaults, options);
	    ...
	    buildChromeHtml() {
	        ...
	        this.content.insertAdjacentHTML('beforeend', lodash_template(this.options.template)(this.options.templateVars));
